...
public class DefaultTurnCostsCalcTest {
    ...
    public void turnCostCalc_shortestRoute_carEncoder() {
        AbstractFlagEncoder encoder = encodingManager.getEncoder(EncodingManager.CAR);
        TurnCostCalculation calc = new DefaultTurnCostsCalc(encoder, new FastestWeighting(encoder));
        calc.setGraph(createTestGraph());
