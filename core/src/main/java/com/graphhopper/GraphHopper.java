...
*/
    ...
    public GHResponse route( GHRequest request )
    {
        ...
        AbstractFlagEncoder flagEncoder = encodingManager.getEncoder(request.getVehicle());
        if (request.turnCosts() == null) {
            ...
            request.turnCosts(new DefaultTurnCostsCalc(flagEncoder, createWeighting(request.getWeighting(), flagEncoder)));
        }
        ...
        {
            Weighting weighting = createWeighting(request.getWeighting(), flagEncoder);
