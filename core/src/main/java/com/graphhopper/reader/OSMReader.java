...
public class OSMReader
{
    ...
    public void processRelations( OSMRelation relation ) throws XMLStreamException
    {
                ...
                && edgeOutFilter != null )
        {
            ...
            {
                for ( TurnCostsEntry entry : restriction.getAsEntries((GraphTurnCosts) graphStorage, edgeOutFilter, edgeInFilter, getWayMap()) )
                {
    ...
    private boolean isTurnCostSupport( GraphStorage graphStorage )
    {
